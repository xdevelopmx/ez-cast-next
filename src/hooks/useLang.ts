...
export const COMMON_TEXTS: {[lang: string]: {[key: string]: string}} = {
    en: {
        ...
        FILES_ERRORS_FILE_TOO_BIG: 'This file has surpassed the space limit of [SIZE] kb',
        FILES_ERRORS_MAX_FILES_REACHED: 'The limit of [MAX_FILES] files has been surpassed',
    ...
    es: {
        ...
        fecha_limite_entrega_de_aplicaciones: 'Fecha límite entrega de aplicaciones',
        ...
        FILES_ERRORS_FILE_TOO_BIG: 'El archivo super el limite maximo de espacio de [SIZE] kb',
        FILES_ERRORS_MAX_FILES_REACHED: 'El maximo de archivos permitido es [MAX_FILES]',
        ...
        llenar_todos_los_campos: 'Por favor llena todos los campos antes de intentar agregar el [TYPE]',
        titulo: 'Titulo',
        rol: 'Rol',
        director: 'Director',
        anio: 'Año',
...
const TEXTS_BY_PATHNAME: {[path: string]: {[lang: string]: {[key: string]: string}}} = {
    ...
    '/talento/editar-perfil': {
        en: {
            ...
            info_basica_biografia_tooltip_body: "We recommend that you write a short text that describes your professional training and interests", 
            info_basica_webpage: "Add here the link of your website or portfolio that best represents your work, remember that this link will be visible on your profile for Headhunters.", 
            ...
            creditos_credito_destacado_tooltip: 'You can highlight up to 3 credits, these will be visible to the Headhunter.',
            creditos_credito_destacado_max_validacion: 'You can only have 3 featured credits at a time, remove another to be able to feature another',
            tipo_vehiculo: 'Vehicle Type',
            activos_vehiculos_max_validacion: 'You can only have up to 5 vehícles, if you want to add another one first you`ll need to delete one',
            tipo_mascota: 'Pet Type',
            activos_mascotas_max_validacion: 'You can only have up to 5 pets, if you want to add another one first you`ll need to delete one',
            tipo_vestuario: 'Clothing Type',
            tipo_vestuario_especifico: 'Specific Clothing Type',
            tipo_prop: 'Prop Type',
            tipo_equipo: 'Equipment Type',
            activos_equipo_deportivo_max_validacion: 'You can only have up to 5 sport equipment, if you want to add another one first you`ll need to delete one',
            ...
            info_basica_cv_tooltip: 'Remember to add the most up-to-date version of your resume in PDF format',
            habilidades_tooltip: 'Include all the skills that differentiate you from others. A Headhunter may be looking for a role with your skills!',
            preferencias_rol_tooltip: 'A role is a role that a person represents within a story, this character can be fictional or real.',
            preferencias_rol_alerta: 'We recommend that you do not limit yourself to a single type of role to have more chances of being selected.',
            preferencias_rol_tipo_de_trabajo_tooltip: 'Select those options that fit your skills',
            preferencias_rol_interesado_trabajo_extra_title: 'Are you interested in extra work',
            ...
            preferencias_rol_interes_en_proyectos_tooltip: 'We recommend selecting both options to increase your chances of being recruited. Do not limit yourself and generate contacts, experience, and new professional credits.',
            preferencias_rol_locacion: 'Main Work Location + Additional',
            preferencias_rol_locacion_tooltip: 'Add the State that you inhabit or frequent the most as Main Location, it also includes an additional location and expands your work possibilities.',
            preferencias_rol_locacion_button: 'Add another location',
            preferencias_rol_locacion_empty_locacion_validation: 'Please select another location before trying to add it',
            preferencias_rol_documentos_subtitulo: '¿What official documents and licenses do you have?',
            preferencias_rol_disponibilidad_subtitulo: 'Some directors request specific activities, let them know if you are willing to do them',
            ...
            filtros_apariencia_alerta: 'This will not be visible on your profile, but will appear in searches based on what you select.',
            ...
            filtros_apariencias_eres_gemelo_o_trillizo: 'Are you an identical twin or triplet',
            filtros_apariencias_particularidades_subtitle: 'Sometimes directors look for specific attributes, let them know if you have any of the following',
        ...
        es: {
            ...
            info_basica_biografia_tooltip_body: " Te recomendamos escribir un texto breve que describa tu formación profesional e intereses", 
            info_basica_webpage: "Añade aquí el link de tu página web o portafolio que mejor represente tu trabajo, recuerda que este link será visible en tu perfil para los Cazatalentos.", 
            ...
            creditos_credito_destacado_tooltip: 'Puedes destacar hasta 3 créditos, estos estarán a la vista del Cazatalento.',
            creditos_credito_destacado_max_validacion: 'Solo puedes tener 3 créditos destacados al mismo tiempo, quita otro para poder destacar otro.',
            tipo_vehiculo: 'Tipo Vehiculo',
            activos_vehiculos_max_validacion: 'Solo puedes tener hasta 5 vehículos, si deseas agregar otro por favor borra algún vehículo',
            tipo_mascota: 'Tipo Mascota',
            activos_mascotas_max_validacion: 'Solo puedes tener hasta 5 mascotas, si deseas agregar otro por favor borra algúna mascota',
            tipo_vestuario: 'Tipo Vestuario',
            tipo_vestuario_especifico: 'Tipo Vestuario Especifico',
            tipo_prop: 'Tipo Prop',
            tipo_equipo: 'Tipo Equipo',
            activos_equipo_deportivo_max_validacion: 'Solo puedes tener hasta 5 mascotas, si deseas agregar otro por favor borra algúna mascota',
            ...
            info_basica_cv_tooltip: 'Recuerda añadir la versión más actualizada de tu currículum en formato PDF',
            habilidades_tooltip: 'Incluye todas las habilidades que te diferencien de los demás. ¡Un Cazatalentos puede estar buscando un rol con tus habilidades!',
            preferencias_rol_tooltip: 'Un rol es un papel que una persona representa dentro de una historia, este personaje puede ser ficticio o real.',
            preferencias_rol_alerta: 'Te recomendamos no cerrarte a un solo tipo de rol para tener más oportunidades de ser seleccionado.',
            preferencias_rol_tipo_de_trabajo_tooltip: 'Selecciona aquellas opciones que vayan de acuerdo a tus habilidades',
            preferencias_rol_interesado_trabajo_extra_title: 'Estás interesado en trabajo de extra',
            preferencias_rol_interesado_trabajo_extra_tooltip: 'Tienes mucha o poca experiencia y conocimiento dentro de un set? Trabajar de extra puede abrirte muchas puertas y darte conocimiento en el campo, además de que es un rol importante y siempre útil en toda producción.',
            preferencias_rol_interesado_trabajo_extra_subtitle: 'Si indicas interés en trabajar como extra, aparecerás en la búsqueda de extras del Director',
            preferencias_rol_interes_en_proyectos: 'Interés en proyectos',
            preferencias_rol_interes_en_proyectos_tooltip: 'Te recomendamos seleccionar ambas opciones, para aumentar tus posibilidades de ser reclutado. No te limites y genera contactos, experiencia, y nuevos créditos profesionales.',
            preferencias_rol_locacion: 'Locación de Trabajo Principal + Adicionales',
            preferencias_rol_locacion_tooltip: 'Agrega el Estado que habites o frecuentes más como Locación Principal, también incluye una locación adicional y amplía tus posibilidades de trabajo.',
            preferencias_rol_locacion_button: 'Agregar otra localizacion',
            preferencias_rol_locacion_empty_locacion_validation: 'Por favor selecciona otra localizacion antes de intentar agregarla',
            preferencias_rol_documentos_subtitulo: '¿Qué documentos oficiales y licencias tienes?',
            preferencias_rol_disponibilidad_subtitulo: 'Algunos directores solicitan actividades específicas, déjales saber si estás dispuesto a realizarlas',
            preferencias_rol_otras_profesiones: 'Otras Profesiones',
            preferencias_rol_otras_profesiones_tooltip: 'Añade algún trabajo que hayas tenido o tengas fuera del medio ¡Tu habilidad podría estar siendo buscada ahora mismo para el rol de un proyecto!',
            filtros_apariencia_alerta: 'Esto no será visible en tu perfil, pero aparecerá en las búsquedas basadas en lo que selecciones.',
            filtros_apariencias_tatuajes_subtitulo: 'Tienes tatuajes distintivos? Es tu oportunidad de informar a los directores de casting.',
            filtros_apariencias_piercings_lugar: 'Lugar',
            filtros_apariencias_piercings_subtitulo: 'Tienes algún piercing? Es tu oportunidad, hazle saber al director de casting.',
            filtros_apariencias_eres_gemelo_o_trillizo: 'Eres gemelo o trillizo idéntico',
            filtros_apariencias_particularidades_subtitle: 'Algunas veces los directores buscan atributos específicos, déjales saber si tienes alguno de los siguientes',
    ...
    '/talento/billboard': {
        ...
        es: {
            ...
            validacion_filtro_con_autorellenado: 'No se puede quitar este filtro cuando esta activada la opcion de autorellenado',
            ...
            no_proyectos_body: 'Asegurate de tener tu perfil al corriente para asi poder brindarte los proyectos de acuerdo a tus carateristicas.',
    ...
    '/talento/self-tape': {
        en: {
            title_text: 'A self-tape is a technique used in the film industry where a person films themselves during a casting audition. Take advantage of this tool and record your auditions in seconds!',
            max_selftapes_reached: 'Only a maximum of 6 self-tapes per user is allowed. Please delete one before attempting to record another',
            current_count_selftape: 'You have [COUNT] self-tapes available in the Media Bank',
        ...
        es: {
            ...
            max_selftapes_reached: 'Solo se permite maximo 6 selftapes por usuario, por favor elimina uno antes de intentar grabar otro',
            current_count_selftape: 'Tienes [COUNT] selftapes disponibles en el Media Bank',
    ...
    '/talento/media-bank': {
        en: {
            dialog_selftape_titulo: 'Select the video you want to upload for your self-tapes',
