...
export const COMMON_TEXTS: { [lang: string]: { [key: string]: string } } = {
  en: {
    ...
    agrega_un_mensaje: 'Add a message',
    elige_tipo_audicion_talento: 'Choose the audition type for the Talent',
    elige_fecha: 'Choose the date of',
    ...
    actualizar_intervalos: "Update time intervals",
    intervalos_generados_para_otro_rol: "Time intervals were generated for another role, do you wish to update the block to use the new role?",
    ...
    audicion_rechazada: 'Discarded audition',
    audicion_confirmada: 'Confirmed audition',
    callback_programado: 'Scheduled callback',
    callback_rechazado: 'Discarded callback',
    callback_confirmado: 'Confirmed callback',
    ...
    no_hay_talentos: 'There is no talents to be assigned',
    ...
    locacion: 'Location',
    sin: 'Without',
    guardar_e_ir_a_roles: 'Save and go to roles',
  ...
  es: {
    ...
    agregar_a_agenda_virtual: 'Agregar a Agenda Virtual',
    disponible_para_membresias_premium: 'Disponible en membresías Premium y Ejecutiva',
    agrega_un_mensaje: 'Agrega un mensaje',
    elige_tipo_audicion_talento: 'Elige el tipo de audición del Talento',
    elige_fecha: 'Elige la fecha para',
    el_callback: 'el callback',
    la_audicion: 'la audición',
    rechazado: 'Rechazado',
    archivar: 'Archivar',
    ...
    actualizar_intervalos: 'Actualizar intervalos de tiempo',
    intervalos_generados_para_otro_rol: 'Los intervalos de tiempo fueron generados para otro rol, deseas actualizar el bloque para utilizar el nuevo rol?',
    ...
    audicion_rechazada: 'Audicion rechazada',
    audicion_confirmada: 'Audicion confirmada',
    callback_programado: 'Callback Programado',
    callback_rechazado: 'Callback rechazado',
    callback_confirmado: 'Callback confirmado',
    ...
    no_hay_talentos: 'No hay talentos que asignar',
    ...
    locacion: 'Locación',
    sin: 'Sin',
    guardar_e_ir_a_roles: 'Guardar e ir a roles',
