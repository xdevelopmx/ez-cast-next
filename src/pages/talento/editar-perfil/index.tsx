            ...
            if (talento.data && talento.data.activos) {
                ...
                dispatch({type: 'update-activos', value: {
                    ...
                    mascotas: (talento.data.activos.mascotas) ? talento.data.activos.mascotas.map(mascota => {
                        return {tipo: mascota.tipo_mascota?.es, id_tipo_mascota: mascota.tipo_mascota?.id, tipo_raza: mascota.raza_mascota?.es,
                    ...
                    vestuarios: (talento.data.activos.vestuario) ? talento.data.activos.vestuario.map(vestuario => {
                        return {tipo: vestuario.tipo_vestuario_especifico?.tipo_vestuario.es, id_tipo: vestuario.tipo_vestuario_especifico?.id_tipo_vestuario,
                    ...
                    <div className={classes['RootContainer']} style={{minHeight: ([1].includes(state.step_active)) ? 'calc(100vh - 76px)' : '100%'}}>
                        ...
                        >
                           <EditarInfoBasicaTalento 
                            ...
                            <EditarPreferenciaRolYCompensacionTalento state={state.preferencias} 
