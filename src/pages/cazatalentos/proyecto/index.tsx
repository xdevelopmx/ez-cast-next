...
import { type ProyectForm } from '~/interfaces'

const initialState: ProyectForm = {
    proyecto: {
        nombre: '',
        sindicato: '',
        tipo: '',
...
function reducer(state: ProyectForm, action: { type: string, value: { [key: string]: string | number } }) {
    switch (action.type) {
        case 'update-proyect-form':
                            ...
                            <form className="needs-validation">
                                <div>
                                    ...
                                    <InformacionGeneral
                                        ...
                                        onFormChange={(input: { [key: string]: string | number }) => {
                                            dispatch({ type: 'update-proyect-form', value: input })
                                            console.log(input);
                                        }}
                                    />
