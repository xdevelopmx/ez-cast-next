...
const reducer = (state: RegistrarTalentoState, action: {type: string, data: unknown}): RegistrarTalentoState => {
    switch (action.type) {
...
const AplicacionesRepresentantePage = () => {
...
export default AplicacionesRepresentantePage;