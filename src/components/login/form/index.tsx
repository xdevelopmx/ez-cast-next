    ...
    <>
        <div className="box_cart_login">
            <div className="login_container text-center">
                ...
                <div>
                    <span className="switch_span switch_login">Cazatalentos</span>
                ...
                <div>
                    <span className="switch_span switch_login active">Talento</span>
                ...
                <div>
                    <span className="switch_span switch_login">Representante</span>
