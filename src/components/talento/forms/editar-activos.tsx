...
import { TalentoFormActivos } from '~/pages/talento/editar-perfil';
                ...
                <MContainer direction='vertical'>
                    ...
                    <MotionDiv show={state.has_props} animation='fade'>
                        <>
                            ...
                            }} style={{ marginTop: 16, padding: 4, fontWeight: 800, color: '#4ab7c6' }} className="btn  btn-social mr-1 ml-1"><Image width={16} height={16} className="mr-2" src="/assets/img/iconos/cruz_blue.svg" alt="Boton de agregar credito"/>Agregar Prop</a>
