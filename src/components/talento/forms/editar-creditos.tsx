...
export const EditarCreditosTalento: FC<Props> = ({
  onFormChange,
  state,
  resetCredits,
  handleCreditos,
    ...
    <Grid container spacing={2}>
      <Grid item xs={12} my={0}>
        <Typography fontSize={"1.6rem"} fontWeight={600} component={"p"}>
          {textos["aniadir"] ? textos["aniadir"] : "Texto No Definido"}{" "}
      ...
      >
        <Grid item xs={20} md={4} lg={4}>
          <MSelect
            ...
            options={
              tipo_proyecto.data
                ? tipo_proyecto.data.map((tipo) => {
                    return {
                      value: tipo.id.toString(),
                      label: ctx.lang === "es" ? tipo.es : tipo.en,
                    };
                  })
                : []
            }
        ...
        <Grid item xs={20} md={4} lg={4}>
          <FormGroup
            ...
            onChange={(e) => {
              onFormChange({ titulo: e.currentTarget.value });
            }}
            label={textos["titulo"] ? textos["titulo"] : "Texto No Definido"}
          />
        </Grid>
        <Grid item xs={20} md={4} lg={4}>
          <MSelect
        ...
        <Grid item xs={20} md={4} lg={4}>
          <FormGroup
            ...
            onChange={(e) => {
              onFormChange({ director: e.currentTarget.value });
            }}
            label={
            ...
            onClick={() => {
              if (state) {
                if (
                  ...
                  state.titulo.length > 0 &&
                  state.rol.length > 0 &&
                  state.director.length > 0 &&
                  state.anio > 0
                ) {
                  onFormChange({
      ...
      <Grid item xs={12} xl={12} my={0}>
        <MContainer direction="vertical">
          <Typography
            ...
            component={"p"}
          >
            {textos["tus"] ? textos["tus"] : "Texto No Definido"}{" "}
            {textos["credito"] ? textos["credito"] : "Texto No Definido"}s
          </Typography>
          <MCheckboxGroup
            onChange={(e) => {
