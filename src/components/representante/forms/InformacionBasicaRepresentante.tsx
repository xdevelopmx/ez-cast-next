      ...
      <Grid item container xs={12}>
        <Grid item container xs={12} mt={4}>
          <Box sx={{ display: "flex", alignItems: "center" }}>
            ...
            <Typography
              fontWeight={600}
              sx={{ fontSize: "1.1rem", color: "#069cb1" }}
            >
              Ubicación
            </Typography>
          </Box>
      ...
      <Grid item container xs={12}>
                ...
                text={
                  <>
                    ...
                    <Typography fontSize={"12px"} fontWeight={400}>
                      Te recomendamos escribir un texto breve que describa tu
                      formación profesional e intereses
                    </Typography>
                  </>
                }
                color="orange"
        ...
        <Grid item xs={12} md={4} className="mt-4" justifyContent={"end"}>
          <DragNDrop
            ...
            tooltip={{
              text: "Recuerda añadir la versión más actualizada de tu currículum en formato PDF",
              color: "orange",
              placement: "top",
            }}
            height={100}
            files={
              props.state.files && props.state.files.cv
                ? [props.state.files.cv]
                : []
            }
            ...
            onChange={(files: File[]) => {
              ...
              files_converted
                .then((files_conv) => {
                  props.onFormChange({
                    files: { ...props.state.files, cv: files_conv[0] },
                  });
                })
                .catch((err) => {
                  console.log(err);
                  props.onFormChange({
                    files: { ...props.state.files, cv: undefined },
                  });
                });
            }}
          />
        ...
        <Grid item xs={12} md={12}>
          ...
          >
            ...
            >
              ...
              <MTooltip
                sx={{ mt: 1 }}
                text="Añade aquí el link de tu página web o portafolio que mejor represente tu trabajo, recuerda que este link será visible en tu perfil para los Cazatalentos."
                color="orange"
                placement="right"
              />
            </MContainer>
            <FormGroup
              className={"form-input-md"}
              value={
                props.state.redes_sociales
                  ? props.state.redes_sociales.pagina_web
                  : ""
              }
              onChange={(e) => {
                props.onFormChange({
        ...
        <Grid item xs={4} md={2}>
          ...
          >
            ...
            <FormGroup
              ...
              value={
                props.state && props.state.redes_sociales
                  ? props.state.redes_sociales.vimeo
                  : ""
              }
              onChange={(e) => {
                props.onFormChange({
        ...
        <Grid item xs={4} md={2}>
          ...
          >
            ...
            <FormGroup
              ...
              value={
                props.state && props.state.redes_sociales
                  ? props.state.redes_sociales.instagram
                  : ""
              }
              onChange={(e) => {
                props.onFormChange({
        ...
        <Grid item xs={4} md={2}>
          ...
          >
            ...
            <FormGroup
              ...
              value={
                props.state && props.state.redes_sociales
                  ? props.state.redes_sociales.youtube
                  : ""
              }
              onChange={(e) => {
                props.onFormChange({
        ...
        <Grid item xs={4} md={2}>
          ...
          >
            ...
            <FormGroup
              ...
              value={
                props.state && props.state.redes_sociales
                  ? props.state.redes_sociales.twitter
                  : ""
              }
              onChange={(e) => {
                props.onFormChange({
        ...
        <Grid item xs={4} md={2}>
          ...
          >
            ...
            <FormGroup
              ...
              value={
                props.state && props.state.redes_sociales
                  ? props.state.redes_sociales.imdb
                  : ""
              }
              onChange={(e) => {
                props.onFormChange({
        ...
        <Grid item xs={4} md={2}>
          ...
          >
            ...
            <FormGroup
              ...
              value={
                props.state && props.state.redes_sociales
                  ? props.state.redes_sociales.linkedin
                  : ""
              }
              onChange={(e) => {
                props.onFormChange({
