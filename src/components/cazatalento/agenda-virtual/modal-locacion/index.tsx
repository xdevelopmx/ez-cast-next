                ...
                <Grid xs={12}>
                    <Grid xs={12}>
                        <FormGroup
                            ...
                            label='Dirección*'
                            onChange={(e) => {
                                setData(prev => { return { ...prev, direccion: e.target.value}})
                            }}
                        />
                    </Grid>
                    <Grid xs={12}>
                        <FormGroup
                            ...
                            label='Dirección 2'
                            onChange={(e) => {
                                setData(prev => { return { ...prev, direccion2: e.target.value}})
                            }}
                        />
                    </Grid>
                    <Grid xs={12}>
                        <MSelect
                            ...
                            onChange={(e) => {
                                setData(prev => { return { ...prev, id_estado_republica: parseInt(e.target.value)}})
                            }}
                    ...
                    <Grid xs={12}>
                        <FormGroup
                            ...
                            onChange={(e) => {
                                setData(prev => { return { ...prev, codigo_postal: parseInt(e.target.value)}})
                            }}
                        />
                    </Grid>
                    <Grid xs={12}>
