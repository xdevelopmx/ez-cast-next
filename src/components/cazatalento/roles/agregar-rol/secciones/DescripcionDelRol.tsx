    ...
    <Grid container item xs={12} mt={8}>
      <Grid item xs={12}>
        <SectionTitle
          ...
          subtitle={`${textos["descripcion_rol"]}`}
          subtitleSx={{
            ml: 4,
            color: "#069cb1",
            fontWeight: 600,
          ...
          <Grid item xs={4} mb={5}>
            ...
            >
              <MSelect
                ...
                value={
                  state.id_color_cabello
                    ? state.id_color_cabello.toString()
                    : "0"
                }
              ...
              <MSelect
                ...
                value={
                  state.id_color_ojos ? state.id_color_ojos.toString() : "0"
                }
                className={"form-input-md"}
                onChange={(e) => {
                  onFormChange({
        ...
        <Grid item container xs={12}>
          <Grid item xs={12} mb={4}>
            <MCheckboxGroup
              ...
              onChange={(e, i) => {
                const habilidad = habilidades.data?.filter(
                  (_, index) => index === i
                )[0];
                if (habilidad) {
                  onFormChange({
                    habilidades: state.habilidades.includes(habilidad.id)
              ...
              values={
                habilidades.data
                  ? habilidades.data.map((g) =>
                      state.habilidades.includes(g.id)
                    )
                  : [false]
              }
            />
          ...
          <Grid item xs={12} mt={4}>
            <DragNDrop
              ...
              noIconLabel={true}
              label={
                <Typography fontWeight={600} sx={estilosBold}>
                  {`${textos["foto_referencia"]}`}:
                </Typography>
              }
              ...
              tooltip={{
                color: "orange",
                placement: "right",
                text: "Te recomendamos agregar fotos para transmitir mejor lo que estás buscando.",
              }}
              mainIcon={
                <Image
              ...
              onChange={(files: File[]) => {
                ...
                files_converted
                  ...
                  .catch((err) => {
                    console.log(err);
                    onFormChange({
                      files: { ...state.files, archivo: undefined },
                    });
                  });
              }}
            />
