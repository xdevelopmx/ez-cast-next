...
import type {
  TipoProyectoPorProyecto,
  Proyecto,
  Roles,
  CompensacionesPorRoles,
  CompNoMonetariasPorRoles,
  CatalogosCompNoMones,
  CatalogoTiposRoles,
  SindicatoPorProyecto,
  CatalogoUniones,
  CatalogoTipoProyectos,
  FiltrosDemoPorRoles,
  GenerosPorRoles,
  CatalogoGeneros,
  ...
  CatalogoPaises,
  HabilidadesPorTalentos,
  HabilidadesSelecPorRoles,
  CatalogoHabilidades,
  NSFWPorRoles,
  NSFWSeleccionadosPorRoles,
  CatalogoNSFW,
  CastingPorRoles,
  CatalogoEstadosRepublica,
  FilmacionPorRoles,
  RequisitosPorRoles,
  CatalogoTipoUsosHorario,
  MediosMultimediaPorRoles,
  CatalogoMediosMultimedia,
  Media,
  Cazatalentos,
...
export const RolesTable = () => {
  ...
  const loading =
    estados.isFetching ||
    uniones.isFetching ||
    tipos_roles.isFetching ||
    tipos_proyectos.isFetching ||
    generos_rol.isFetching ||
    apariencias_etnicas.isFetching ||
    preferencias_pago.isFetching;
