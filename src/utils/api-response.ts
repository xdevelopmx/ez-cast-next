    ...
    const API_RESPONSES_TEXTS: {[route: string]: {[lang: string]: {[key: string]: string}}} = {
        ...
        AgendaVirtualRouter_sendHorarios: {
            en: {
                ...
                message_headhunter_audition_text: `<p style="font-size: 12px;">The talent scout <span style="color: white; font-weight: 800;">[N1] [N2]</span> has confirmed your <span style="color: white; font-weight: 800;">callback</span> on the day <span style="color: white; font-weight: 800;">[N3] at [N4] hours</span> for the role of <span style="color: white; font-weight: 800;">[N5]</span>. Please contact us via message to know the last-minute details for your casting.</p>`,
                message_headhunter_callback_text: `<p style="font-size: 12px;"><span style="color: white; font-weight: 800;">[N1] [N2]</span> has confirmed your <span style="color: white; font-weight: 800;">audition</span> on the day <span style="color: white; font-weight: 800;">[N3] at [N4] hours</span> for the role of <span style="color: white; font-weight: 800;">[N5]</span>. Please contact us via message to receive last-minute details for your casting</p>`,
            },
            es: {
                ...
                message_headhunter_audition_text: `<p style="font-size: 12px;">El cazatalentos <span style="color: white; font-weight: 800;">[N1] [N2]</span> ha confirmado tu <span style="color: white; font-weight: 800;">callback</span>
                ...
                comunicate por mensaje para saber los detalles de último minuto para tu casting.</p>`,
                message_headhunter_callback_text: `<p style="font-size: 12px;">El cazatalentos <span style="color: white; font-weight: 800;">[N1] [N2]</span> ha confirmado tu <span style="color: white; font-weight: 800;">audición</span>
                el día <span style="color: white; font-weight: 800;">[N3] a las [N4] horas</span> para el rol de <span style="color: white; font-weight: 800;">[N5]</span>, 
                comunicate por mensaje para saber los detalles de último minuto para tu casting.</p>`,
            },
        },
        ...
        AgendaVirtualRouter_create: {
            en: {
                message_create: `<p style="font-size: 12px;">We have some bad news <span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> has canceled the casting for <span style="color: white; font-weight: 800;">[N5]</span> on <span style="color: white; font-weight: 800;">[N6] at [N7] hours</span>.</p>`,
            ...
            es: {
                message_create: `<p style="font-size: 12px;">Tenemos una mala noticia <span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> ha cancelado el
                casting de <span style="color: white; font-weight: 800;">[N5]</span> para <span style="color: white; font-weight: 800;">[N6] a las [N7] horas</span>.</p>`,
        ...
        AgendaVirtualRouter_updateIntervaloHorario: {
            en: {
                alert_message_callback_confirmado: `<p style="font-size: 12px;"><span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> has confirmed the callback on <span style="color: white; font-weight: 800;">[N5] at [N6] hours</span> for the role of <span style="color: white; font-weight: 800;">[N7]</span>. Let them know the last-minute details for their casting.</p>`,
                alert_message_audicion_confirmado: `
                <p style="font-size: 12px;"><span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> has confirmed the audition on <span style="color: white; font-weight: 800;">[N5] at [N6] hours</span> for the role of <span style="color: white; font-weight: 800;">[N7]</span>. Let them know the last-minute details for their casting.</p>`,
                alert_message_callback_rechazado: `<p style="font-size: 12px;">Hello <span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> has declined the callback on <span style="color: white; font-weight: 800;">[N5] at [N6] hours</span> for the role of <span style="color: white; font-weight: 800;">[N7]</span>. Let them know if you have any available dates and schedules for the casting.</p>`,
                alert_message_audicion_rechazado: `<p style="font-size: 12px;">Hello <span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> has declined the audition on <span style="color: white; font-weight: 800;">[N5] at [N6] hours</span> for the role of <span style="color: white; font-weight: 800;">[N7]</span>. Let them know if you have any available dates and schedules for the casting.</p>`,
                error_saved_intervalos: 'There was a problem trying to save the intervals.',
                error_solo_cazatalentos: 'Only the talent scout role can create schedules.'
            },
            es: {
                alert_message_callback_confirmado: `<p style="font-size: 12px;"><span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> ha confirmado el callback el día 
                ...
                casting.</p>`,
                alert_message_audicion_confirmado: `<p style="font-size: 12px;"><span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> ha confirmado la audicion el día 
                <span style="color: white; font-weight: 800;">[N5] a las [N6] horas</span> para el rol de <span style="color: white; font-weight: 800;">[N7]</span>, déjale saber los detalles de último minuto para su
                casting.</p>`,
                alert_message_callback_rechazado: `<p style="font-size: 12px;">¡Hola <span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> ha rechazado el callback el día 
                <span style="color: white; font-weight: 800;">[N5] a las [N6] horas”</span> para el rol de <span style="color: white; font-weight: 800;">[N7]</span>, déjale saber si tienes fechas y horarios disponibles para el casting.</p>`,
                alert_message_audicion_rechazado: `<p style="font-size: 12px;">¡Hola <span style="color: white; font-weight: 800;">[N1] [N2]</span>, <span style="color: white; font-weight: 800;">[N3] [N4]</span> ha rechazado la audicion el día 
                <span style="color: white; font-weight: 800;">[N5] a las [N6] horas”</span> para el rol de <span style="color: white; font-weight: 800;">[N7]</span>, déjale saber si tienes fechas y horarios disponibles para el casting.</p>`,
        ...
        CazatalentosRouter_updateSeleccionTalento: {
            en: {
                ...
                cazatalento_alerta_callback: `<p style="font-size: 12px;">You have been <span style="color: white;">selected</span>! You have a <span style="color: white;">[N1]</span> for <b>[N2]</b>. You will be receiving casting information very soon. Congratulations on advancing to the second stage!</p>`,
                cazatalento_alerta_audicion: `<p style="font-size: 12px;">You have been <span style="color: white;">selected</span>! You have a <span style="color: white;">[N1]</span> for <b>[N2]</b>. You will be receiving casting information very soon. Congratulations on advancing to the first stage!</p>`,
            },
            es: {
                id_role_not_found: 'No se encontro el rol con ese id',
                error_rol_invalido: 'Solo el rol de cazatalento puede modificar la calificacion del talento.',
                ...
                cazatalento_alerta_callback: `<p style="font-size: 12px;">¡Has sido <span style="color: white;">seleccionad@</span>! Tendrás una <span style="color: white;">[N1]</span> para <b>[N2]</b>. Estarás recibiendo información del casting muy pronto. ¡Felicidades por pasar a la segunda etapa!</p>`,
                cazatalento_alerta_audicion: `<p style="font-size: 12px;">¡Has sido <span style="color: white;">seleccionad@</span>! Tendrás una <span style="color: white;">[N1]</span> para <b>[N2]</b>. Estarás recibiendo información del casting muy pronto. ¡Felicidades por pasar a la primera etapa!</p>`,
            }
        },
        ...
        ProyectosRouter_updateEstadoProyecto: {
            en: {
                ...
                message_proyecto_aprobado: `<p style="font-size: 12px;">Your project <span style="color: white; font-weight: 800;">[N1]</span> has been successfully approved! We recommend you to stay alert for the applications you receive to find and recruit your talent as soon as possible.</p>`,
                message_proyecto_rechazado: `<p style="font-size: 12px;">Your project <span style="color: white; font-weight: 800;">[N1]</span> has been rejected! We recommend you to review the following observations to make the necessary corrections: </br> <span style="color: white; font-weight: 800;">[N2].</span></p>`,
            ...
            es: {
                ...
                message_proyecto_aprobado: `<p style="font-size: 12px;">¡Tu proyecto <span style="color: white; font-weight: 800;">[N1]</span> ha sido aprobado con éxito!
                Te recomendamos estar atento a las aplicaciones que recibas para así encontrar y reclutar a tu
                talento lo más pronto posible.</p>`,
                message_proyecto_rechazado: `<p style="font-size: 12px;">¡Tu proyecto <span style="color: white; font-weight: 800;">[N1]</span> ha sido rechazado!
                Te recomendamos revisar las siguientes observaciones para que sean corregidos: </br> <span style="color: white; font-weight: 800;">[N2].</span></p>`,
        ...
        RolesRouter_createAplicacionTalento: {
            en: {
                ...
                alerta_message: `<p style="font-size: 12px;">Hello <b>[N1] [N2]</b>! You have received <span style="color: white;">new applications</span> for your project <b>[N3]</b>, access your <a style="text-decoration: underline; color: white;" href="/cazatalentos/billboard">personalized billboard</a> and select your favorites using the <span style="color: white">highlight</span> tool.</p>`
            },
            es: {
                ...
                alerta_message: `<p style="font-size: 12px;">¡Hola <b>[N1] [N2]</b>! Has recibido
